...
public class InjectAttributeRegexTesterTest {
	...
	public void testInjectAttributeRegexTester() throws Exception {
		...
		// test with an injected attribute not given, so like equals test. Should return
		// true.
		IPersonTester tester1 = new InjectAttributeRegexTester(TestPersonAttributesGroupTestDefinition
		...
		IPersonTester tester2 = new InjectAttributeRegexTester(
				TestPersonAttributesGroupTestDefinition.mockIPersonAttributesGroupTestDefinition1(key3, testValue2));
		...
		IPersonTester tester3 = new InjectAttributeRegexTester(
				TestPersonAttributesGroupTestDefinition.mockIPersonAttributesGroupTestDefinition1(key3, testValue3));
		...
		IPersonTester tester5 = new InjectAttributeRegexTester(
				TestPersonAttributesGroupTestDefinition.mockIPersonAttributesGroupTestDefinition1(key1, testValue5));
		...
		IPersonTester tester6 = new InjectAttributeRegexTester(
				TestPersonAttributesGroupTestDefinition.mockIPersonAttributesGroupTestDefinition1(key4, testValue6));
