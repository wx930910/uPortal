...
public class PAGSTest extends TestCase {
	...
	public void testStringEqualsTester() throws Exception {
		...
		IPersonTester tester1 = new StringEqualsTester(TestPersonAttributesGroupTestDefinition
				.mockIPersonAttributesGroupTestDefinition1(key1, randomStrings[0]));
		IPersonTester tester2 = new StringEqualsTester(TestPersonAttributesGroupTestDefinition
				.mockIPersonAttributesGroupTestDefinition1(key2, randomStrings[1]));
		IPersonTester tester3 = new StringEqualsTester(TestPersonAttributesGroupTestDefinition
				.mockIPersonAttributesGroupTestDefinition1(key3, randomStrings[testVectorSize - 1]));
		IPersonTester tester4 = new StringEqualsTester(TestPersonAttributesGroupTestDefinition
				.mockIPersonAttributesGroupTestDefinition1(key3, randomStrings[0] + "x"));
		IPersonTester tester5 = new StringEqualsTester(TestPersonAttributesGroupTestDefinition
				.mockIPersonAttributesGroupTestDefinition1(missingKey, randomStrings[0]));
	...
	public void testStringEqualsIgnoreCaseTester() throws Exception {
		...
		IPersonTester tester1 = new StringEqualsIgnoreCaseTester(
				TestPersonAttributesGroupTestDefinition.mockIPersonAttributesGroupTestDefinition1(key1, testKey));
		IPersonTester tester2 = new StringEqualsIgnoreCaseTester(TestPersonAttributesGroupTestDefinition
				.mockIPersonAttributesGroupTestDefinition1(key2, randomStrings[1]));
	...
	public void testIntegerEQTester() throws Exception {
		...
		IPersonTester tester1 = new IntegerEQTester(TestPersonAttributesGroupTestDefinition
				.mockIPersonAttributesGroupTestDefinition1(key1, randomIntStrings[0]));
		IPersonTester tester2 = new IntegerEQTester(TestPersonAttributesGroupTestDefinition
				.mockIPersonAttributesGroupTestDefinition1(key2, randomIntStrings[1]));
		IPersonTester tester3 = new IntegerEQTester(TestPersonAttributesGroupTestDefinition
				.mockIPersonAttributesGroupTestDefinition1(key3, randomIntStrings[testVectorSize - 1]));
		IPersonTester tester4 = new IntegerEQTester(
				TestPersonAttributesGroupTestDefinition.mockIPersonAttributesGroupTestDefinition1(key3, "0"));
	...
	public void testIntegerGTTester() throws Exception {
		...
		IPersonTester tester1 = new IntegerGTTester(TestPersonAttributesGroupTestDefinition
				.mockIPersonAttributesGroupTestDefinition1(key1, randomIntStrings[0]));
		// test value < attribute value. Should answer true.
		IPersonTester tester2 = new IntegerGTTester(
				TestPersonAttributesGroupTestDefinition.mockIPersonAttributesGroupTestDefinition1(key2, "0"));
		// test value > any attribute value. Should answer false.
		IPersonTester tester3 = new IntegerGTTester(
				TestPersonAttributesGroupTestDefinition.mockIPersonAttributesGroupTestDefinition1(key3, INTEGER_MAX));
		// test value < any attribute value. Should answer true.
		IPersonTester tester4 = new IntegerGTTester(TestPersonAttributesGroupTestDefinition
				.mockIPersonAttributesGroupTestDefinition1(key3, "" + INTEGER_MIN));
		// attribute value not present. Should answer false.
		IPersonTester tester5 = new IntegerGTTester(
				TestPersonAttributesGroupTestDefinition.mockIPersonAttributesGroupTestDefinition1(missingKey, "0"));
	...
	public void testIntegerLTTester() throws Exception {
		...
		// test value == attribute value. Should answer false.
		IPersonTester tester1 = new IntegerLTTester(TestPersonAttributesGroupTestDefinition
				.mockIPersonAttributesGroupTestDefinition1(key1, randomIntStrings[0]));
		// test value < attribute value. Should answer false.
		IPersonTester tester2 = new IntegerLTTester(
				TestPersonAttributesGroupTestDefinition.mockIPersonAttributesGroupTestDefinition1(key2, "0"));
		// test value > any attribute value. Should answer true.
		IPersonTester tester3 = new IntegerLTTester(TestPersonAttributesGroupTestDefinition
				.mockIPersonAttributesGroupTestDefinition1(key3, "" + INTEGER_MAX));
		// test value < any attribute value. Should answer false.
		IPersonTester tester4 = new IntegerLTTester(TestPersonAttributesGroupTestDefinition
				.mockIPersonAttributesGroupTestDefinition1(key3, "" + INTEGER_MIN));
		// test value > attribute value. Should answer true.
		IPersonTester tester5 = new IntegerLTTester(TestPersonAttributesGroupTestDefinition
				.mockIPersonAttributesGroupTestDefinition1(key1, "" + INTEGER_MAX));
	...
	public void testIntegerGETester() throws Exception {
		...
		// test value == attribute value. Should answer true.
		IPersonTester tester1 = new IntegerGETester(TestPersonAttributesGroupTestDefinition
				.mockIPersonAttributesGroupTestDefinition1(key1, randomIntStrings[0]));
		// test value < attribute value. Should answer true.
		IPersonTester tester2 = new IntegerGETester(
				TestPersonAttributesGroupTestDefinition.mockIPersonAttributesGroupTestDefinition1(key2, "0"));
		// test value > any attribute value. Should answer false.
		IPersonTester tester3 = new IntegerGETester(TestPersonAttributesGroupTestDefinition
				.mockIPersonAttributesGroupTestDefinition1(key3, "" + INTEGER_MAX));
		// test value < any attribute value. Should answer true.
		IPersonTester tester4 = new IntegerGETester(TestPersonAttributesGroupTestDefinition
				.mockIPersonAttributesGroupTestDefinition1(key3, "" + INTEGER_MIN));
		// test value > attribute value. Should answer false.
		IPersonTester tester5 = new IntegerGETester(TestPersonAttributesGroupTestDefinition
				.mockIPersonAttributesGroupTestDefinition1(key1, "" + INTEGER_MAX));
	...
	public void testIntegerLETester() throws Exception {
		...
		// test value == attribute value. Should answer true.
		IPersonTester tester1 = new IntegerLETester(TestPersonAttributesGroupTestDefinition
				.mockIPersonAttributesGroupTestDefinition1(key1, randomIntStrings[0]));
		// test value < attribute value. Should answer false.
		IPersonTester tester2 = new IntegerLETester(
				TestPersonAttributesGroupTestDefinition.mockIPersonAttributesGroupTestDefinition1(key2, "0"));
		// test value > any attribute value. Should answer true.
		IPersonTester tester3 = new IntegerLETester(TestPersonAttributesGroupTestDefinition
				.mockIPersonAttributesGroupTestDefinition1(key3, "" + INTEGER_MAX));
		// test value < any attribute value. Should answer false.
		IPersonTester tester4 = new IntegerLETester(TestPersonAttributesGroupTestDefinition
				.mockIPersonAttributesGroupTestDefinition1(key3, "" + INTEGER_MIN));
		// test value > attribute value. Should answer true.
		IPersonTester tester5 = new IntegerLETester(TestPersonAttributesGroupTestDefinition
				.mockIPersonAttributesGroupTestDefinition1(key1, "" + INTEGER_MAX));
	...
	public void testRegexTester() throws Exception {
		...
		IPersonTester tester1 = new RegexTester(TestPersonAttributesGroupTestDefinition
				.mockIPersonAttributesGroupTestDefinition1(key1, randomStrings[0]));

		// test and attribute begin with same String. Should return true.
		String testValue2 = randomStrings[0].substring(0, 1) + ".*";
		IPersonTester tester2 = new RegexTester(
				TestPersonAttributesGroupTestDefinition.mockIPersonAttributesGroupTestDefinition1(key1, testValue2));

		// test and attribute begin with different String. Should return false.
		String testValue3 = "^[0]";
		IPersonTester tester3 = new RegexTester(
				TestPersonAttributesGroupTestDefinition.mockIPersonAttributesGroupTestDefinition1(key1, testValue3));
		...
		IPersonTester tester4 = new RegexTester(
				TestPersonAttributesGroupTestDefinition.mockIPersonAttributesGroupTestDefinition1(key2, testValue4));

		// test and attribute end with different String. Should return false.
		String testValue5 = ".*9$";
		IPersonTester tester5 = new RegexTester(
				TestPersonAttributesGroupTestDefinition.mockIPersonAttributesGroupTestDefinition1(key2, testValue5));

		// test value is same as last String in Vector. Should return true.
		String testValue6 = "^" + ((String) stringVector.lastElement()) + "$";
		IPersonTester tester6 = new RegexTester(
				TestPersonAttributesGroupTestDefinition.mockIPersonAttributesGroupTestDefinition1(key3, testValue6));
	...
	public void testValueExistsTester() throws Exception {
		...
		IPersonTester tester1 = new ValueExistsTester(
				TestPersonAttributesGroupTestDefinition.mockIPersonAttributesGroupTestDefinition1(key1, testKey));
		IPersonTester tester2 = new ValueExistsTester(
				TestPersonAttributesGroupTestDefinition.mockIPersonAttributesGroupTestDefinition1(key2, null));
		// This test should fail; the IPerson does not have a value for key3.
		IPersonTester tester3 = new ValueExistsTester(
				TestPersonAttributesGroupTestDefinition.mockIPersonAttributesGroupTestDefinition1(key3, new String()));
	...
	public void testValueMissingTester() throws Exception {
		...
		IPersonTester tester1 = new ValueMissingTester(TestPersonAttributesGroupTestDefinition
				.mockIPersonAttributesGroupTestDefinition1(key1, randomStrings[0]));
		// This test should pass; the attribute is blank.
		IPersonTester tester2 = new ValueMissingTester(
				TestPersonAttributesGroupTestDefinition.mockIPersonAttributesGroupTestDefinition1(key2, testKey));
		// This test should pass; the IPerson does not have a value for key3.
		IPersonTester tester3 = new ValueMissingTester(
				TestPersonAttributesGroupTestDefinition.mockIPersonAttributesGroupTestDefinition1(key3, testKey));
